...
public class Msg {
    ...
    public static final String animalAddedMsg = "This animal is added to zoo";
    public static final String animalNotAddedMsg = "This animal is not added to zoo";
    public static final String nobodyRemovedMsg = "Nobody removed from zoo (invalid animal id)";
    ...
    public static final Map<Integer, String> mainMenuEntriesMsg = Map.ofEntries(
